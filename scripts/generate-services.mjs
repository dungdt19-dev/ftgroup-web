...
const SERVICES = [
  ...
  },
  {
    ...
    title: 'In quảng cáo &amp; CNC sự kiện | FT GROUP E&amp;E',
    desc:
      'In ấn backdrop, POSM, OOH và gia công CNC chữ nổi, logo khối cho sự kiện — giao hàng đúng timeline setup. FT GROUP E&amp;E Hà Nội &amp; miền Bắc.',
    h1: 'In quảng cáo &amp; CNC',
    heroLede:
      'Ấn phẩm in ấn và gia công CNC cho sự kiện — key visual thống nhất từ backdrop, chữ nổi, decor khối đến POSM.',
    heroImg:
      'https://images.unsplash.com/photo-1561070791-2526d30994b5?auto=format&fit=crop&w=1920&q=80',
    keywords: `${COMMON_KEYWORDS}, in quảng cáo sự kiện, gia công CNC, in backdrop`,
    introH2: 'In ấn &amp; gia công CNC theo brand guideline',
    introP: [
      'Từ file thiết kế đến in proof và CNC — chúng tôi tư vấn khổ cắt, loại giấy, vật liệu khắc (acrylic, MDF, mica) và gia công sau in để sản phẩm bền màu indoor/outdoor.',
      'Đặt lịch theo timeline sự kiện — đồng bộ với đội dựng backdrop &amp; sân khấu để mảng visual thông suốt một đầu mối.',
    ],
    benefits: [
